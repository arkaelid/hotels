...
<body>
    ...
    <input type="hidden" name="Payment" value="{$unPaiementtype->getPayment()}"> <!-- Utilisez la méthode getPayment() -->
    
    <div class="form-group">
        <label for="description">Description du type de paiement</label>
        <input type="text" class="form-control" id="description" name="description" value="{$unPaiementtype->getDescription()}"> <!-- Utilisez la méthode getDescription() -->
    </div>
